...
enum class ApiTargetType {
    JUDGEMENT, JUDGEMENT_WITH_VOTE, MEDIA_ITEM, MEDIA_ITEM_TEMPORAL_RANGE, TEXT, TEXT_MEDIA_ITEM_TEMPORAL_RANGE;
    ...
    fun toDb(): DbTargetType = when(this) {
        ...
        TEXT_MEDIA_ITEM_TEMPORAL_RANGE -> DbTargetType.TEXT_MEDIA_ITEM_TEMPORAL_RANGE
    }
}
